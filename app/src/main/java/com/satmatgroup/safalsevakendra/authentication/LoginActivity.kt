    ...
    override fun onAPICallCompleteListner(item: Any?, flag: String?, result: String) {
        if (flag.equals(LOGIN_API)) {
            ...
            if (status.contains(TRUE)) {
                ...
                callServiceGetOTP(userModel.cus_mobile,token)
               /* val intent = Intent(this, MainActivity::class.java)
                startActivity(intent)
                finish()*/
...
*/
    ...
    private fun callServiceGetOTP(mobileNo: String, token: String) {
        ...
        val call: Call<SendOTPResponse?>? = apiService.sendOTPService(mobileNo,otp,"SPI4999")
        ...
        call!!.enqueue(object : Callback<SendOTPResponse?> {
            override fun onResponse(call: Call<SendOTPResponse?>, response: Response<SendOTPResponse?>) {
             //   Toast.makeText(this@LoginActivity,response.body()!!.getMessage()!!,Toast.LENGTH_LONG).show()
